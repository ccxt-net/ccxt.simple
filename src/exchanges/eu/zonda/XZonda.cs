...
namespace CCXT.Simple.Exchanges.Zonda
{
    public class XZonda : IExchange
    {
        /*
         * Zonda Exchange Implementation
         * 
         * API Documentation: https://api.zonda.exchange
         * 
         * Rate Limits: TBD
         */

        public XZonda(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "zonda";
        public string ExchangeUrl { get; set; } = "https://api.zonda.exchange";
