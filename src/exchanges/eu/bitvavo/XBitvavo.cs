...
namespace CCXT.Simple.Exchanges.Bitvavo
{
    public class XBitvavo : IExchange
    {
        /*
         * Bitvavo Exchange Implementation
         * 
         * API Documentation: https://api.bitvavo.com
         * 
         * Rate Limits: TBD
         */

        public XBitvavo(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "bitvavo";
        public string ExchangeUrl { get; set; } = "https://api.bitvavo.com";
