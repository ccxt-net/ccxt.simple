...
namespace CCXT.Simple.Exchanges.Onetrading
{
    public class XOnetrading : IExchange
    {
        /*
         * Onetrading Exchange Implementation
         * 
         * API Documentation: https://api.onetrading.com
         * 
         * Rate Limits: TBD
         */

        public XOnetrading(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "onetrading";
        public string ExchangeUrl { get; set; } = "https://api.onetrading.com";
