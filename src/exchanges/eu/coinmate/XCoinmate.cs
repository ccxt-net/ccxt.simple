...
namespace CCXT.Simple.Exchanges.Coinmate
{
    public class XCoinmate : IExchange
    {
        /*
         * Coinmate Exchange Implementation
         * 
         * API Documentation: https://coinmate.io
         * 
         * Rate Limits: TBD
         */

        public XCoinmate(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "coinmate";
        public string ExchangeUrl { get; set; } = "https://coinmate.io";
