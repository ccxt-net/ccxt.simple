...
namespace CCXT.Simple.Exchanges.Exmo
{
    public class XExmo : IExchange
    {
        /*
         * Exmo Exchange Implementation
         * 
         * API Documentation: https://api.exmo.com
         * 
         * Rate Limits: TBD
         */

        public XExmo(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "exmo";
        public string ExchangeUrl { get; set; } = "https://api.exmo.com";
