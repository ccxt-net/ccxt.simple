...
namespace CCXT.Simple.Exchanges.Whitebit
{
    public class XWhitebit : IExchange
    {
        /*
         * Whitebit Exchange Implementation
         * 
         * API Documentation: https://api.whitebit.com
         * 
         * Rate Limits: TBD
         */

        public XWhitebit(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeUrl { get; set; } = "https://api.whitebit.com";
