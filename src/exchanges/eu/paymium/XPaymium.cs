...
namespace CCXT.Simple.Exchanges.Paymium
{
    public class XPaymium : IExchange
    {
        /*
         * Paymium Exchange Implementation
         * 
         * API Documentation: https://api.paymium.com
         * 
         * Rate Limits: TBD
         */

        public XPaymium(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "paymium";
        public string ExchangeUrl { get; set; } = "https://api.paymium.com";
