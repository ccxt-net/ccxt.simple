...
namespace CCXT.Simple.Exchanges.Yobit
{
    public class XYobit : IExchange
    {
         ...
         * 
         * API Documentation: https://yobit.net
         * 
         * Rate Limits: TBD
         */

        public XYobit(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "yobit";
        public string ExchangeUrl { get; set; } = "https://yobit.net";
