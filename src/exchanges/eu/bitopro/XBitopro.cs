...
namespace CCXT.Simple.Exchanges.Bitopro
{
    public class XBitopro : IExchange
    {
        /*
         * Bitopro Exchange Implementation
         * 
         * API Documentation: https://api.bitopro.com
         * 
         * Rate Limits: TBD
         */

        public XBitopro(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "bitopro";
        public string ExchangeUrl { get; set; } = "https://api.bitopro.com";
