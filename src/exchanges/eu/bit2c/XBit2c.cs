...
namespace CCXT.Simple.Exchanges.Bit2c
{
    public class XBit2c : IExchange
    {
        /*
         * Bit2c Exchange Implementation
         * 
         * API Documentation: https://api.bit2c.co.il
         * 
         * Rate Limits: TBD
         */

        public XBit2c(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "bit2c";
        public string ExchangeUrl { get; set; } = "https://api.bit2c.co.il";
