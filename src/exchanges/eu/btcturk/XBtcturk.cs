...
namespace CCXT.Simple.Exchanges.Btcturk
{
    public class XBtcturk : IExchange
    {
        /*
         * Btcturk Exchange Implementation
         * 
         * API Documentation: https://api.btcturk.com
         * 
         * Rate Limits: TBD
         */

        public XBtcturk(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "btcturk";
        public string ExchangeUrl { get; set; } = "https://api.btcturk.com";
