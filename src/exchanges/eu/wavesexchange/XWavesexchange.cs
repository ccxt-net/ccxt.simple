...
namespace CCXT.Simple.Exchanges.Wavesexchange
{
    public class XWavesexchange : IExchange
    {
        /*
         * Wavesexchange Exchange Implementation
         * 
         * API Documentation: https://api.wavesplatform.com
         * 
         * Rate Limits: TBD
         */

        public XWavesexchange(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "wavesexchange";
        public string ExchangeUrl { get; set; } = "https://api.wavesplatform.com";
