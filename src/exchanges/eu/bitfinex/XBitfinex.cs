...
namespace CCXT.Simple.Exchanges.Bitfinex
{
    public class XBitfinex : IExchange
    {
        /*
        ...
        public XBitfinex(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "bitfinex";
        public string ExchangeUrl { get; set; } = "https://api.bitfinex.com";
