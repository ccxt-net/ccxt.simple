...
namespace CCXT.Simple.Exchanges.Fmfwio
{
    public class XFmfwio : IExchange
    {
        /*
         * Fmfwio Exchange Implementation
         * 
         * API Documentation: https://api.fmfw.io
         * 
         * Rate Limits: TBD
         */

        public XFmfwio(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "fmfwio";
        public string ExchangeUrl { get; set; } = "https://api.fmfw.io";
