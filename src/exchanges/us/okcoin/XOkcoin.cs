...
namespace CCXT.Simple.Exchanges.Okcoin
{
    /// <summary>
    /// OKCoin spot exchange adapter skeleton.
    /// </summary>
    /// <inheritdoc cref="CCXT.Simple.Core.Interfaces.IExchange" />
    public class XOkcoin : IExchange
    {
        /*
         * Okcoin Exchange Implementation
         * 
         * API Documentation: https://www.okcoin.com
         * 
         * Rate Limits: TBD
         */

        /// <summary>
        /// Initializes the OKCoin adapter.
        /// </summary>
        public XOkcoin(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        /// <inheritdoc />
        public string ExchangeName { get; set; } = "okcoin";

        /// <inheritdoc />
        public string ExchangeUrl { get; set; } = "https://www.okcoin.com";
