...
namespace CCXT.Simple.Exchanges.Gemini
{
    /// <summary>
    /// Gemini spot exchange adapter skeleton.
    /// </summary>
    /// <inheritdoc cref="CCXT.Simple.Core.Interfaces.IExchange" />
    public class XGemini : IExchange
    {
        /*
        ...
        /// </summary>
        public XGemini(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        /// <inheritdoc />
        public string ExchangeName { get; set; } = "gemini";

        /// <inheritdoc />
        public string ExchangeUrl { get; set; } = "https://api.gemini.com";
