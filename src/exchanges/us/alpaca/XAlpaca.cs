...
namespace CCXT.Simple.Exchanges.Alpaca
{
    /// <summary>
    /// Alpaca exchange adapter skeleton.
    /// </summary>
    /// <inheritdoc cref="CCXT.Simple.Core.Interfaces.IExchange" />
    public class XAlpaca : IExchange
    {
        /*
         * Alpaca Exchange Implementation
         * 
         * API Documentation: https://api.alpaca.markets
         * 
         * Rate Limits: TBD
         */
        ...
        /// </summary>
        public XAlpaca(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        /// <inheritdoc />
        public string ExchangeName { get; set; } = "alpaca";

        /// <inheritdoc />
        public string ExchangeUrl { get; set; } = "https://api.alpaca.markets";
