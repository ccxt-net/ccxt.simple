...
namespace CCXT.Simple.Exchanges.CoinbaseAdvanced
{
    /// <summary>
    /// Coinbase Advanced Trade (spot) adapter skeleton.
    /// </summary>
    /// <inheritdoc cref="CCXT.Simple.Core.Interfaces.IExchange" />
    public class XCoinbaseAdvanced : IExchange
    {
        /*
         * CoinbaseAdvanced Exchange Implementation
         * 
         * API Documentation: https://api.coinbase.com
         * 
         * Rate Limits: TBD
         */
    /// <summary>
    ...
    /// </summary>
    public XCoinbaseAdvanced(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
    ...
    /// <inheritdoc />
    public string ExchangeName { get; set; } = "coinbaseadvanced";
