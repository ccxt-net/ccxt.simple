...
namespace CCXT.Simple.Exchanges.Paradex
{
    /// <summary>
    /// Paradex spot exchange adapter skeleton.
    /// </summary>
    /// <inheritdoc cref="CCXT.Simple.Core.Interfaces.IExchange" />
    public class XParadex : IExchange
    {
        /*
         * Paradex Exchange Implementation
         * 
         * API Documentation: https://api.paradex.io
         * 
         * Rate Limits: TBD
         */

        /// <summary>
        /// Initializes the Paradex adapter.
        /// </summary>
        public XParadex(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        /// <inheritdoc />
        public string ExchangeName { get; set; } = "paradex";

        /// <inheritdoc />
        public string ExchangeUrl { get; set; } = "https://api.paradex.io";
