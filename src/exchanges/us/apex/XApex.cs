...
namespace CCXT.Simple.Exchanges.Apex
{
    /// <summary>
    /// Apex spot exchange adapter skeleton.
    /// </summary>
    /// <inheritdoc cref="CCXT.Simple.Core.Interfaces.IExchange" />
    public class XApex : IExchange
    {
        /*
         * Apex Exchange Implementation
         * 
         * API Documentation: https://api.apex.exchange
         * 
         * Rate Limits: TBD
         */

        /// <summary>
        /// Initializes the Apex adapter.
        /// </summary>
        public XApex(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        /// <inheritdoc />
        public string ExchangeName { get; set; } = "apex";

        /// <inheritdoc />
        public string ExchangeUrl { get; set; } = "https://api.apex.exchange";
