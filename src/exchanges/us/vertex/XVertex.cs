...
namespace CCXT.Simple.Exchanges.Vertex
{
    /// <summary>
    /// Vertex exchange adapter skeleton.
    /// </summary>
    /// <inheritdoc cref="CCXT.Simple.Core.Interfaces.IExchange" />
    public class XVertex : IExchange
    {
        /*
         * Vertex Exchange Implementation
         * 
         * API Documentation: https://api.vertex.fi
         * 
         * Rate Limits: TBD
         */

        /// <summary>
        /// Initializes the Vertex adapter.
        /// </summary>
        public XVertex(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        /// <inheritdoc />
        public string ExchangeName { get; set; } = "vertex";

        /// <inheritdoc />
        public string ExchangeUrl { get; set; } = "https://api.vertex.fi";
