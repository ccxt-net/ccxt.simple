...
namespace CCXT.Simple.Exchanges.BinanceUsdm
{
    /// <summary>
    /// Binance USD-M Futures exchange adapter skeleton.
    /// </summary>
    /// <inheritdoc cref="CCXT.Simple.Core.Interfaces.IExchange" />
    public class XBinanceUsdm : IExchange
    {
        /*
         * BinanceUsdm Exchange Implementation
         * 
         * API Documentation: https://fapi.binance.com
         * 
         * Rate Limits: TBD
         */

        /// <summary>
        /// Initializes the Binance USD-M Futures adapter.
        /// </summary>
        public XBinanceUsdm(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        /// <inheritdoc />
        public string ExchangeName { get; set; } = "binanceusdm";

        /// <inheritdoc />
        public string ExchangeUrl { get; set; } = "https://fapi.binance.com";
