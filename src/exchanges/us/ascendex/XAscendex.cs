...
namespace CCXT.Simple.Exchanges.Ascendex
{
    /// <summary>
    /// AscendEX spot exchange adapter skeleton.
    /// </summary>
    /// <inheritdoc cref="CCXT.Simple.Core.Interfaces.IExchange" />
    public class XAscendex : IExchange
    {
        /*
         * Ascendex Exchange Implementation
         * 
         * API Documentation: https://api.ascendex.com
         * 
         * Rate Limits: TBD
         */

        /// <summary>
        /// Initializes the AscendEX adapter.
        /// </summary>
        public XAscendex(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        /// <inheritdoc />
        public string ExchangeName { get; set; } = "ascendex";

        /// <inheritdoc />
        public string ExchangeUrl { get; set; } = "https://api.ascendex.com";
