...
namespace CCXT.Simple.Exchanges.Cryptocom
{
    /// <summary>
    /// Crypto.com (app) exchange adapter skeleton.
    /// </summary>
    /// <inheritdoc cref="CCXT.Simple.Core.Interfaces.IExchange" />
    public class XCryptocom : IExchange
    {
        /*
         * Cryptocom Exchange Implementation
         * 
         * API Documentation: https://api.crypto.com
         * 
         * Rate Limits: TBD
         */

        /// <summary>
        /// Initializes the Crypto.com adapter.
        /// </summary>
        public XCryptocom(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        /// <inheritdoc />
        public string ExchangeName { get; set; } = "cryptocom";
