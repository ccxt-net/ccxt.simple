...
namespace CCXT.Simple.Exchanges.Okxus
{
    /// <summary>
    /// OKX (US) spot exchange adapter skeleton.
    /// </summary>
    /// <inheritdoc cref="CCXT.Simple.Core.Interfaces.IExchange" />
    public class XOkxus : IExchange
    {
        /*
         * Okxus Exchange Implementation
         * 
         * API Documentation: https://www.okx.com
         * 
         * Rate Limits: TBD
         */

        /// <summary>
        /// Initializes the OKX US adapter.
        /// </summary>
        public XOkxus(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        /// <inheritdoc />
        public string ExchangeName { get; set; } = "okxus";
