...
namespace CCXT.Simple.Exchanges.CoinbaseExchange
{
    /// <summary>
    /// Coinbase Exchange adapter skeleton.
    /// </summary>
    /// <inheritdoc cref="CCXT.Simple.Core.Interfaces.IExchange" />
    public class XCoinbaseExchange : IExchange
    {
        /*
         * CoinbaseExchange Exchange Implementation
         * 
         * API Documentation: https://api.exchange.coinbase.com
         * 
         * Rate Limits: TBD
         */

        /// <summary>
        /// Initializes the Coinbase Exchange adapter.
        /// </summary>
        public XCoinbaseExchange(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        /// <inheritdoc />
        public string ExchangeName { get; set; } = "coinbaseexchange";
