...
namespace CCXT.Simple.Exchanges.Phemex
{
    /// <summary>
    /// Phemex spot exchange adapter skeleton.
    /// </summary>
    /// <inheritdoc cref="CCXT.Simple.Core.Interfaces.IExchange" />
    public class XPhemex : IExchange
    {
        /*
         * Phemex Exchange Implementation
         * 
         * API Documentation: https://api.phemex.com
         * 
         * Rate Limits: TBD
         */

        /// <summary>
        /// Initializes the Phemex adapter.
        /// </summary>
        public XPhemex(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        /// <inheritdoc />
        public string ExchangeName { get; set; } = "phemex";

        /// <inheritdoc />
        public string ExchangeUrl { get; set; } = "https://api.phemex.com";
