...
namespace CCXT.Simple.Exchanges.Krakenfutures
{
    /// <summary>
    /// Kraken Futures exchange adapter skeleton.
    /// </summary>
    /// <inheritdoc cref="CCXT.Simple.Core.Interfaces.IExchange" />
    public class XKrakenfutures : IExchange
    {
        /*
         * Krakenfutures Exchange Implementation
         * 
         * API Documentation: https://futures.kraken.com
         * 
         * Rate Limits: TBD
         */

        /// <summary>
        /// Initializes the Kraken Futures adapter.
        /// </summary>
        public XKrakenfutures(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        /// <inheritdoc />
        public string ExchangeName { get; set; } = "krakenfutures";

        /// <inheritdoc />
        public string ExchangeUrl { get; set; } = "https://futures.kraken.com";
