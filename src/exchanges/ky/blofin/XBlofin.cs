...
namespace CCXT.Simple.Exchanges.Blofin
{
    public class XBlofin : IExchange
    {
        /*
         * Blofin Exchange Implementation
         * 
         * API Documentation: https://api.blofin.com
         * 
         * Rate Limits: TBD
         */

        public XBlofin(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "blofin";
        public string ExchangeUrl { get; set; } = "https://api.blofin.com";
