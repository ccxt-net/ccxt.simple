...
namespace CCXT.Simple.Exchanges.Bitmart
{
    public class XBitmart : IExchange
    {
        /*
         * Bitmart Exchange Implementation
         * 
         * API Documentation: https://api-cloud.bitmart.com
         * 
         * Rate Limits: TBD
         */

        public XBitmart(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "bitmart";
        public string ExchangeUrl { get; set; } = "https://api-cloud.bitmart.com";
