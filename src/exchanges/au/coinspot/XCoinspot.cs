...
namespace CCXT.Simple.Exchanges.Coinspot
{
    public class XCoinspot : IExchange
    {
        /*
         * Coinspot Exchange Implementation
         * 
         * API Documentation: https://www.coinspot.com.au
         * 
         * Rate Limits: TBD
         */

        public XCoinspot(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "coinspot";
        public string ExchangeUrl { get; set; } = "https://www.coinspot.com.au";
