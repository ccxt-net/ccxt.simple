...
namespace CCXT.Simple.Exchanges.Btcmarkets
{
    public class XBtcmarkets : IExchange
    {
        /*
         * Btcmarkets Exchange Implementation
         * 
         * API Documentation: https://api.btcmarkets.net
         * 
         * Rate Limits: TBD
         */

        public XBtcmarkets(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "btcmarkets";
        public string ExchangeUrl { get; set; } = "https://api.btcmarkets.net";
