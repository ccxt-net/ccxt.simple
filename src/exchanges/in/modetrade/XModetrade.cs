...
namespace CCXT.Simple.Exchanges.Modetrade
{
    public class XModetrade : IExchange
    {
        /*
         * Modetrade Exchange Implementation
         * 
         * API Documentation: https://api.modetrade.com
         * 
         * Rate Limits: TBD
         */

        public XModetrade(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "modetrade";
        public string ExchangeUrl { get; set; } = "https://api.modetrade.com";
