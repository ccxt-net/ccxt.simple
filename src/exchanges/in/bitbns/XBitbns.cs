...
namespace CCXT.Simple.Exchanges.Bitbns
{
    public class XBitbns : IExchange
    {
        /*
         * Bitbns Exchange Implementation
         * 
         * API Documentation: https://api.bitbns.com
         * 
         * Rate Limits: TBD
         */

        public XBitbns(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "bitbns";
        public string ExchangeUrl { get; set; } = "https://api.bitbns.com";
