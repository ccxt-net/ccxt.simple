...
namespace CCXT.Simple.Exchanges.Coinsph
{
    public class XCoinsph : IExchange
    {
        /*
         * Coinsph Exchange Implementation
         * 
         * API Documentation: https://api.pro.coins.ph
         * 
         * Rate Limits: TBD
         */

        public XCoinsph(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "coinsph";
        public string ExchangeUrl { get; set; } = "https://api.pro.coins.ph";
