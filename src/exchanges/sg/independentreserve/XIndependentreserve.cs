...
namespace CCXT.Simple.Exchanges.Independentreserve
{
    ...
    {
        /*
         * Independentreserve Exchange Implementation
         * 
         * API Documentation: https://api.independentreserve.com
         * 
         * Rate Limits: TBD
         */

        public XIndependentreserve(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "independentreserve";
        public string ExchangeUrl { get; set; } = "https://api.independentreserve.com";
