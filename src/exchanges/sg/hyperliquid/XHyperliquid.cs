...
namespace CCXT.Simple.Exchanges.Hyperliquid
{
    public class XHyperliquid : IExchange
    {
        /*
         * Hyperliquid Exchange Implementation
         * 
         * API Documentation: https://api.hyperliquid.xyz
         * 
         * Rate Limits: TBD
         */

        public XHyperliquid(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "hyperliquid";
        public string ExchangeUrl { get; set; } = "https://api.hyperliquid.xyz";
