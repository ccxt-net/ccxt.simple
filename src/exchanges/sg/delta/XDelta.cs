...
namespace CCXT.Simple.Exchanges.Delta
{
    public class XDelta : IExchange
    {
        /*
         * Delta Exchange Implementation
         * 
         * API Documentation: https://api.delta.exchange
         * 
         * Rate Limits: TBD
         */

        public XDelta(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "delta";
        public string ExchangeUrl { get; set; } = "https://api.delta.exchange";
