...
namespace CCXT.Simple.Exchanges.Derive
{
    public class XDerive : IExchange
    {
        /*
         * Derive Exchange Implementation
         * 
         * API Documentation: https://api.derive.com
         * 
         * Rate Limits: TBD
         */

        public XDerive(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "derive";
        public string ExchangeUrl { get; set; } = "https://api.derive.com";
