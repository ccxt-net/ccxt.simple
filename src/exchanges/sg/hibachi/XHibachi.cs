...
namespace CCXT.Simple.Exchanges.Hibachi
{
    public class XHibachi : IExchange
    {
        /*
         * Hibachi Exchange Implementation
         * 
         * API Documentation: https://api.hibachi.com
         * 
         * Rate Limits: TBD
         */

        public XHibachi(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "hibachi";
        public string ExchangeUrl { get; set; } = "https://api.hibachi.com";
