...
namespace CCXT.Simple.Exchanges.Ellipx
{
    public class XEllipx : IExchange
    {
        /*
         * Ellipx Exchange Implementation
         * 
         * API Documentation: https://api.ellipx.com
         * 
         * Rate Limits: TBD
         */

        public XEllipx(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "ellipx";
        public string ExchangeUrl { get; set; } = "https://api.ellipx.com";
