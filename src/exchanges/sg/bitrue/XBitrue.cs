...
namespace CCXT.Simple.Exchanges.Bitrue
{
    public class XBitrue : IExchange
    {
        /*
         * Bitrue Exchange Implementation
         * 
         * API Documentation: https://api.bitrue.com
         * 
         * Rate Limits: TBD
         */

        public XBitrue(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "bitrue";
        public string ExchangeUrl { get; set; } = "https://api.bitrue.com";
