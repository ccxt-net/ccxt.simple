...
namespace CCXT.Simple.Exchanges.Htx
{
    public class XHtx : IExchange
    {
        /*
         * Htx Exchange Implementation
         * 
         * API Documentation: https://api.huobi.pro
         * 
         * Rate Limits: TBD
         */

        public XHtx(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "htx";
