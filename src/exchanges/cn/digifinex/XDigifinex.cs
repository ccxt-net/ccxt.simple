...
namespace CCXT.Simple.Exchanges.Digifinex
{
    public class XDigifinex : IExchange
    {
        /*
         * Digifinex Exchange Implementation
         * 
         * API Documentation: https://api.digifinex.com
         * 
         * Rate Limits: TBD
         */

        public XDigifinex(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "digifinex";
        public string ExchangeUrl { get; set; } = "https://api.digifinex.com";
