...
namespace CCXT.Simple.Exchanges.Lbank
{
    public class XLbank : IExchange
    {
        /*
         * Lbank Exchange Implementation
         * 
         * API Documentation: https://api.lbankapi.com
         * 
         * Rate Limits: TBD
         */

        public XLbank(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "lbank";
        public string ExchangeUrl { get; set; } = "https://api.lbankapi.com";
