...
namespace CCXT.Simple.Exchanges.Hitbtc
{
    public class XHitbtc : IExchange
    {
        /*
         * Hitbtc Exchange Implementation
         * 
         * API Documentation: https://api.hitbtc.com
         * 
         * Rate Limits: TBD
         */

        public XHitbtc(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "hitbtc";
        public string ExchangeUrl { get; set; } = "https://api.hitbtc.com";
