...
namespace CCXT.Simple.Exchanges.Coinex
{
    public class XCoinex : IExchange
    {
        /*
         * Coinex Exchange Implementation
         * 
         * API Documentation: https://api.coinex.com
         * 
         * Rate Limits: TBD
         */

        public XCoinex(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "coinex";
        public string ExchangeUrl { get; set; } = "https://api.coinex.com";
