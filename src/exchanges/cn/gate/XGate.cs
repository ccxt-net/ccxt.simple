...
namespace CCXT.Simple.Exchanges.Gate
{
    ...
    {
        /*
         * Gate Exchange Implementation
         * 
         * API Documentation: https://api.gate.io
         * 
         * Rate Limits: TBD
         */

        public XGate(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeUrl { get; set; } = "https://api.gate.io";
