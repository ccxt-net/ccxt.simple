...
namespace CCXT.Simple.Exchanges.Xt
{
    public class XXt : IExchange
    {
        /*
         * Xt Exchange Implementation
         * 
         * API Documentation: https://api.xt.com
         * 
         * Rate Limits: TBD
         */

        public XXt(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "xt";
        public string ExchangeUrl { get; set; } = "https://api.xt.com";
