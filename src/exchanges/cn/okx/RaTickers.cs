namespace CCXT.Simple.Exchanges.Okx
{
    ...
    {
        /// <summary>Instrument type (e.g. SPOT, SWAP)</summary>
        public string instType { get; set; }
        /// <summary>Instrument identifier (e.g. BTC-USDT)</summary>
        ...
        /// <summary>24h open price</summary>
        public decimal open24h { get; set; }
        /// <summary>24h high price</summary>
        public decimal high24h { get; set; }
        /// <summary>24h low price</summary>
        public decimal low24h { get; set; }
        /// <summary>24h volume in quote currency (volCcy)</summary>
        public decimal volCcy24h { get; set; }
        /// <summary>24h volume in base currency</summary>
        public decimal vol24h { get; set; }
        /// <summary>Ticker timestamp (milliseconds)</summary>
        public long ts { get; set; }
        /// <summary>Start-of-day price UTC0</summary>
        public decimal sodUtc0 { get; set; }
        /// <summary>Start-of-day price UTC+8</summary>
    ...
    public class RaTickers
    {
        ...
        /// <summary>Error or information message</summary>
        public string msg { get; set; }
        /// <summary>List of ticker entries</summary>
