...
namespace CCXT.Simple.Exchanges.Hashkey
{
    public class XHashkey : IExchange
    {
        /*
         * Hashkey Exchange Implementation
         * 
         * API Documentation: https://api.hashkey.com
         * 
         * Rate Limits: TBD
         */

        public XHashkey(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "hashkey";
        public string ExchangeUrl { get; set; } = "https://api.hashkey.com";
