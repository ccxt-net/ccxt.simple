...
namespace CCXT.Simple.Exchanges.Kucoinfutures
{
    public class XKucoinfutures : IExchange
    {
        /*
         * Kucoinfutures Exchange Implementation
         * 
         * API Documentation: https://api-futures.kucoin.com
         * 
         * Rate Limits: TBD
         */

        public XKucoinfutures(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "kucoinfutures";
        public string ExchangeUrl { get; set; } = "https://api-futures.kucoin.com";
