...
namespace CCXT.Simple.Exchanges.Bigone
{
    public class XBigone : IExchange
    {
        /*
         * Bigone Exchange Implementation
         * 
         * API Documentation: https://api.big.one
         * 
         * Rate Limits: TBD
         */

        public XBigone(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "bigone";
        public string ExchangeUrl { get; set; } = "https://api.big.one";
