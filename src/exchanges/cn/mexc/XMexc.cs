...
namespace CCXT.Simple.Exchanges.Mexc
{
    public class XMexc : IExchange
    {
        /*
        ...
        public XMexc(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "mexc";
        public string ExchangeUrl { get; set; } = "https://api.mexc.com";
