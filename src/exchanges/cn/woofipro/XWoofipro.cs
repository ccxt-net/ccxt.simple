...
namespace CCXT.Simple.Exchanges.Woofipro
{
    public class XWoofipro : IExchange
    {
        /*
         * Woofipro Exchange Implementation
         * 
         * API Documentation: https://api.woo.network
         * 
         * Rate Limits: TBD
         */

        public XWoofipro(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "woofipro";
        public string ExchangeUrl { get; set; } = "https://api.woo.network";
