...
namespace CCXT.Simple.Exchanges.Woo
{
    public class XWoo : IExchange
    {
        /*
         * Woo Exchange Implementation
         * 
         * API Documentation: https://api.woo.org
         * 
         * Rate Limits: TBD
         */

        public XWoo(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "woo";
        public string ExchangeUrl { get; set; } = "https://api.woo.org";
