...
namespace CCXT.Simple.Exchanges.Ndax
{
    public class XNdax : IExchange
    {
        /*
         * Ndax Exchange Implementation
         * 
         * API Documentation: https://api.ndax.io
         * 
         * Rate Limits: TBD
         */

        public XNdax(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "ndax";
        public string ExchangeUrl { get; set; } = "https://api.ndax.io";
