...
namespace CCXT.Simple.Exchanges.Timex
{
    public class XTimex : IExchange
    {
        /*
         * Timex Exchange Implementation
         * 
         * API Documentation: https://api.timex.io
         * 
         * Rate Limits: TBD
         */

        public XTimex(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "timex";
        public string ExchangeUrl { get; set; } = "https://api.timex.io";
