...
namespace CCXT.Simple.Exchanges.Defx
{
    public class XDefx : IExchange
    {
        /*
         * Defx Exchange Implementation
         * 
         * API Documentation: https://api.defx.com
         * 
         * Rate Limits: TBD
         */

        public XDefx(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "defx";
        public string ExchangeUrl { get; set; } = "https://api.defx.com";
