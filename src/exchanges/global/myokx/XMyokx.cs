...
namespace CCXT.Simple.Exchanges.Myokx
{
    public class XMyokx : IExchange
    {
        /*
        ...
        public XMyokx(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "myokx";
