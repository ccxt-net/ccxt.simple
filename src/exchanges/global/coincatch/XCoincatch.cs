...
namespace CCXT.Simple.Exchanges.Coincatch
{
    public class XCoincatch : IExchange
    {
        /*
         * Coincatch Exchange Implementation
         * 
         * API Documentation: https://api.coincatch.com
         * 
         * Rate Limits: TBD
         */

        public XCoincatch(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "coincatch";
        public string ExchangeUrl { get; set; } = "https://api.coincatch.com";
