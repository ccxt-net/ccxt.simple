...
namespace CCXT.Simple.Exchanges.Hollaex
{
    public class XHollaex : IExchange
    {
        /*
         * Hollaex Exchange Implementation
         * 
         * API Documentation: https://api.hollaex.com
         * 
         * Rate Limits: TBD
         */

        public XHollaex(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "hollaex";
        public string ExchangeUrl { get; set; } = "https://api.hollaex.com";
