...
namespace CCXT.Simple.Exchanges.P2b
{
    public class XP2b : IExchange
    {
        /*
         * P2b Exchange Implementation
         * 
         * API Documentation: https://api.p2b.com
         * 
         * Rate Limits: TBD
         */

        public XP2b(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "p2b";
        public string ExchangeUrl { get; set; } = "https://api.p2b.com";
