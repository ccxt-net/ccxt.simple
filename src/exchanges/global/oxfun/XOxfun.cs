...
namespace CCXT.Simple.Exchanges.Oxfun
{
    public class XOxfun : IExchange
    {
        /*
         * Oxfun Exchange Implementation
         * 
         * API Documentation: https://api.ox.fun
         * 
         * Rate Limits: TBD
         */

        public XOxfun(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "oxfun";
        public string ExchangeUrl { get; set; } = "https://api.ox.fun";
