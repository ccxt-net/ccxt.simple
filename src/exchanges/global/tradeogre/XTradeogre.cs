...
namespace CCXT.Simple.Exchanges.Tradeogre
{
    public class XTradeogre : IExchange
    {
        /*
         * Tradeogre Exchange Implementation
         * 
         * API Documentation: https://tradeogre.com
         * 
         * Rate Limits: TBD
         */

        public XTradeogre(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "tradeogre";
        public string ExchangeUrl { get; set; } = "https://tradeogre.com";
