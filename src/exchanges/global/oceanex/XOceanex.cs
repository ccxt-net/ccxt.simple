...
namespace CCXT.Simple.Exchanges.Oceanex
{
    public class XOceanex : IExchange
    {
        /*
         * Oceanex Exchange Implementation
         * 
         * API Documentation: https://api.oceanex.pro
         * 
         * Rate Limits: TBD
         */

        public XOceanex(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "oceanex";
        public string ExchangeUrl { get; set; } = "https://api.oceanex.pro";
