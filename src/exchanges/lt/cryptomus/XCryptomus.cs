...
namespace CCXT.Simple.Exchanges.Cryptomus
{
    public class XCryptomus : IExchange
    {
        /*
         * Cryptomus Exchange Implementation
         * 
         * API Documentation: https://api.cryptomus.com
         * 
         * Rate Limits: TBD
         */

        public XCryptomus(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "cryptomus";
        public string ExchangeUrl { get; set; } = "https://api.cryptomus.com";
