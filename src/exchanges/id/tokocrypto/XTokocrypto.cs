...
namespace CCXT.Simple.Exchanges.Tokocrypto
{
    public class XTokocrypto : IExchange
    {
        /*
         * Tokocrypto Exchange Implementation
         * 
         * API Documentation: https://api.tokocrypto.com
         * 
         * Rate Limits: TBD
         */

        public XTokocrypto(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "tokocrypto";
        public string ExchangeUrl { get; set; } = "https://api.tokocrypto.com";
