...
namespace CCXT.Simple.Exchanges.Deribit
{
    public class XDeribit : IExchange
    {
        /*
         * Deribit Exchange Implementation
         * 
         * API Documentation: https://www.deribit.com
         * 
         * Rate Limits: TBD
         */

        public XDeribit(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "deribit";
        public string ExchangeUrl { get; set; } = "https://www.deribit.com";
