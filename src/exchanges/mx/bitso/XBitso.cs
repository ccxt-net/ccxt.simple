...
namespace CCXT.Simple.Exchanges.Bitso
{
    public class XBitso : IExchange
    {
        /*
         * Bitso Exchange Implementation
         * 
         * API Documentation: https://api.bitso.com
         * 
         * Rate Limits: TBD
         */

        public XBitso(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "bitso";
        public string ExchangeUrl { get; set; } = "https://api.bitso.com";
