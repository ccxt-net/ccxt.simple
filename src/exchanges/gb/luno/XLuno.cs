...
namespace CCXT.Simple.Exchanges.Luno
{
    public class XLuno : IExchange
    {
        /*
         * Luno Exchange Implementation
         * 
         * API Documentation: https://api.luno.com
         * 
         * Rate Limits: TBD
         */

        public XLuno(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "luno";
        public string ExchangeUrl { get; set; } = "https://api.luno.com";
