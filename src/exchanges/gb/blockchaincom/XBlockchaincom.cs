...
namespace CCXT.Simple.Exchanges.Blockchaincom
{
    public class XBlockchaincom : IExchange
    {
        /*
         * Blockchaincom Exchange Implementation
         * 
         * API Documentation: https://api.blockchain.com
         * 
         * Rate Limits: TBD
         */

        public XBlockchaincom(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "blockchaincom";
        public string ExchangeUrl { get; set; } = "https://api.blockchain.com";
