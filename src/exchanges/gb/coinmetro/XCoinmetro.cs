...
namespace CCXT.Simple.Exchanges.Coinmetro
{
    public class XCoinmetro : IExchange
    {
        /*
         * Coinmetro Exchange Implementation
         * 
         * API Documentation: https://api.coinmetro.com
         * 
         * Rate Limits: TBD
         */

        public XCoinmetro(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "coinmetro";
        public string ExchangeUrl { get; set; } = "https://api.coinmetro.com";
