...
namespace CCXT.Simple.Exchanges.Bitteam
{
    public class XBitteam : IExchange
    {
        /*
         * Bitteam Exchange Implementation
         * 
         * API Documentation: https://api.bitteam.com
         * 
         * Rate Limits: TBD
         */

        public XBitteam(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "bitteam";
        public string ExchangeUrl { get; set; } = "https://api.bitteam.com";
