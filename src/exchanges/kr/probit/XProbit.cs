...
namespace CCXT.Simple.Exchanges.Probit
{
    public class XProbit : IExchange
    {
        /*
         * Probit Exchange Implementation
         * 
         * API Documentation: https://api.probit.com
         * 
         * Rate Limits: TBD
         */

        public XProbit(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "probit";
        public string ExchangeUrl { get; set; } = "https://api.probit.com";
