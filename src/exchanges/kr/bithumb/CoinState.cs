namespace CCXT.Simple.Exchanges.Bithumb
{
    ...
    public class CsData
    {
        ...
        /// <summary>
        /// Network type (e.g. Mainnet, ERC-20)
        /// </summary>
        public string networkType { get; set; }

        /// <summary>
        /// Withdrawal availability flag (Y/N)
        /// </summary>
        public string outAvailableYn { get; set; }

        /// <summary>
        /// Whether a secondary address (tag/memo) is required (Y/N)
        /// </summary>
        public string scndAddrYn { get; set; }

        /// <summary>
        /// Secondary address name (Korean)
        /// </summary>
        public string scndAddrNmKr { get; set; }

        /// <summary>
        /// Secondary address name (English)
        /// </summary>
