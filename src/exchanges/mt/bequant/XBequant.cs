...
namespace CCXT.Simple.Exchanges.Bequant
{
    public class XBequant : IExchange
    {
        /*
         * Bequant Exchange Implementation
         * 
         * API Documentation: https://api.bequant.com
         * 
         * Rate Limits: TBD
         */

        public XBequant(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "bequant";
        public string ExchangeUrl { get; set; } = "https://api.bequant.com";
