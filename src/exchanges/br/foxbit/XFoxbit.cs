...
namespace CCXT.Simple.Exchanges.Foxbit
{
    public class XFoxbit : IExchange
    {
        /*
         * Foxbit Exchange Implementation
         * 
         * API Documentation: https://api.foxbit.com.br
         * 
         * Rate Limits: TBD
         */

        public XFoxbit(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "foxbit";
        public string ExchangeUrl { get; set; } = "https://api.foxbit.com.br";
