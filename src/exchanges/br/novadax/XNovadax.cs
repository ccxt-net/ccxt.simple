...
namespace CCXT.Simple.Exchanges.Novadax
{
    public class XNovadax : IExchange
    {
        /*
         * Novadax Exchange Implementation
         * 
         * API Documentation: https://api.novadax.com
         * 
         * Rate Limits: TBD
         */

        public XNovadax(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "novadax";
        public string ExchangeUrl { get; set; } = "https://api.novadax.com";
