...
namespace CCXT.Simple.Exchanges.Mercado
{
    public class XMercado : IExchange
    {
        /*
         * Mercado Exchange Implementation
         * 
         * API Documentation: https://api.mercadobitcoin.net
         * 
         * Rate Limits: TBD
         */

        public XMercado(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "mercado";
        public string ExchangeUrl { get; set; } = "https://api.mercadobitcoin.net";
