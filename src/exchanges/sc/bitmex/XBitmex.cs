...
namespace CCXT.Simple.Exchanges.Bitmex
{
    public class XBitmex : IExchange
    {
        /*
         * Bitmex Exchange Implementation
         * 
         * API Documentation: https://www.bitmex.com
         * 
         * Rate Limits: TBD
         */

        public XBitmex(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "bitmex";
        public string ExchangeUrl { get; set; } = "https://www.bitmex.com";
