...
namespace CCXT.Simple.Exchanges.Bitbank
{
    public class XBitbank : IExchange
    {
        /*
         * Bitbank Exchange Implementation
         * 
         * API Documentation: https://api.bitbank.cc
         * 
         * Rate Limits: TBD
         */

        public XBitbank(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "bitbank";
        public string ExchangeUrl { get; set; } = "https://api.bitbank.cc";
