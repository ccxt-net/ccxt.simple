...
namespace CCXT.Simple.Exchanges.Zaif
{
    public class XZaif : IExchange
    {
        /*
         * Zaif Exchange Implementation
         * 
         * API Documentation: https://api.zaif.jp
         * 
         * Rate Limits: TBD
         */

        public XZaif(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "zaif";
        public string ExchangeUrl { get; set; } = "https://api.zaif.jp";
