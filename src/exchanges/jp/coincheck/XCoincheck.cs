...
namespace CCXT.Simple.Exchanges.Coincheck
{
    public class XCoincheck : IExchange
    {
        /*
         * Coincheck Exchange Implementation
         * 
         * API Documentation: https://coincheck.com
         * 
         * Rate Limits: TBD
         */

        public XCoincheck(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "coincheck";
        public string ExchangeUrl { get; set; } = "https://coincheck.com";
