...
namespace CCXT.Simple.Exchanges.Bittrade
{
    public class XBittrade : IExchange
    {
        /*
         * Bittrade Exchange Implementation
         * 
         * API Documentation: https://api.bittrade.co.jp
         * 
         * Rate Limits: TBD
         */

        public XBittrade(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "bittrade";
        public string ExchangeUrl { get; set; } = "https://api.bittrade.co.jp";
