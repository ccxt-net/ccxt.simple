...
namespace CCXT.Simple.Exchanges.Btcbox
{
    public class XBtcbox : IExchange
    {
        /*
         * Btcbox Exchange Implementation
         * 
         * API Documentation: https://www.btcbox.co.jp
         * 
         * Rate Limits: TBD
         */

        public XBtcbox(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "btcbox";
        public string ExchangeUrl { get; set; } = "https://www.btcbox.co.jp";
