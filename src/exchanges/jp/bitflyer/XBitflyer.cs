...
namespace CCXT.Simple.Exchanges.Bitflyer
{
    public class XBitflyer : IExchange
    {
        /*
         * Bitflyer Exchange Implementation
         * 
         * API Documentation: https://api.bitflyer.com
         * 
         * Rate Limits: TBD
         */

        public XBitflyer(Exchange mainXchg, string apiKey = "", string secretKey = "", string passPhrase = "")
        {
        ...
        public string ExchangeName { get; set; } = "bitflyer";
        public string ExchangeUrl { get; set; } = "https://api.bitflyer.com";
