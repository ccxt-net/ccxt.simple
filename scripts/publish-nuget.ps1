# CCXT.Simple NuGet Package Publisher
# This script builds and publishes the CCXT.Simple package to NuGet.org
...
Write-Host ""
Write-Info "========================================="
Write-Info "  CCXT.Simple NuGet Package Publisher"
Write-Info "========================================="
Write-Host ""
...
if ($DryRun) {
    ...
    Write-Success "========================================="
    Write-Host ""
    Write-Info "Package URL: https://www.nuget.org/packages/CCXT.SIMPLE/"
